...
export default function QuoteGeneratorIncomplete() {
    ...
    return (
        <div className="quote-generator-container">
            <div className="quote-card">
                ...
                <p className="scenario-description">Falta el elemento con la cotización total (quote-status)</p>
                ...
                {quote && (
                    <div className="quote-result incomplete">
